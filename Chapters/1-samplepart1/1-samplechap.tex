...
Tudor operated between the component and system levels, while Eno is somewhere between system and interaction. However, Tudor's wish to see personality emerge from circuits is echoed by Eno's \begin{quote} acceptation of that passive role \end{quote} which characterizes the first half of \emph{Discreet Music}. 
...
\begin{quote} ... having laid down, I realized that the amplifier was set at an extremely low level, and that one channel of the stereo had failed completely. Since I hadn't the energy to get up and improve matters, the record played almost inaudibly. This presented what was for me a new way of hearing music - as part of the ambience of the environment.\end{quote}
...
\begin{figure}[h!]
  \caption{Operational Diagram for \textbf{discreetdiagram}}
  \centering
    \includegraphics[width=0.5\textwidth]{enodiscreet}
\end{figure}
